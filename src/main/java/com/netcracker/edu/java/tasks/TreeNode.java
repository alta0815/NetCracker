...
public interface TreeNode {
    ...
    String getTreePath();
    /**
     * Finds the (first) node with the given data in the parents' hierarchy of this <code>TreeNode</code>.
     *  The hierarchy includes this node (i.e. the following may be true: obj.findParent(*) == obj).<br/>
     * Data objects should be compared by equals() method (but beware of nulls; they are compared by ==).
